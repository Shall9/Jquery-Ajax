...
const listurl=`https://api.iextrading.com/1.0/stock/market/ohlc`;
$.ajax({
  url: listurl,
  method: 'GET'
}).then(function(response) {
//  console.log(Object.keys(response))
validationList =Object.keys(response)
...
const displayStockInfo = function () {
  ...
  //check if the stock is present  in validation list if yes run ajax call else ahow alert search no stock
